...
class stem_v2(nn.Module):
    def __init__(self):
        ...
        self.conv0 = nn.Conv2d(3, 32, kernel_size=3, stride=2, padding="VALID")
        ...
        self.maxpool_0_0 = nn.MaxPool2d(kernel_size=3, stride=2, padding="VALID")
        self.conv_1_0 = nn.Conv2d(64, 96, kernel_size=3, stride=2, padding="VALID")

        self.conv_0_1 = nn.Conv2d(160, 64, kernel_size=1)
        self.conv_0_2 = nn.Conv2d(64, 96, padding="VALID")

        self.l0_1 = nn.Sequential(self.conv_0_1, self.conv_0_2)

        self.conv_1_1 = nn.Conv2d(160, 64, kernel_size=1)
        self.conv_1_2 = nn.Conv2d(64, 64, kernel_size=(7, 1))
        self.conv_1_3 = nn.Conv2d(64, 64, kernel_size=(1, 7))
        self.conv_1_4 = nn.Conv2d(64, 96, kernel_size=3, padding="VALID")

        self.l1_1 = nn.Sequential(
            self.conv_1_1, self.conv_1_2, self.conv_1_3, self.conv_1_4
        )

        self.conv_0_3 = nn.Conv2d(192, 192, kernel_size=3, padding="VALID")
        self.maxpool_1_5 = nn.MaxPool2d(stride=2, padding="VALID")
...
class InceptionA(nn.Module):
    def __init__(self, channels_in):
        ...
        self.conv_2_1 = nn.Conv2d(64, 96, kernel_size=3)

        self.conv_3_0 = nn.Conv2d(channels_in, 64, kernel_size=1)
        self.conv_3_1 = nn.Conv2d(64, 96, kernel_size=3)
        self.conv_3_2 = nn.Conv2d(96, 96, kernel_size=3)
...
class ReductionA(nn.Module):
    def __init__(self, channels_in, k, l, m, n):
        ...
        self.conv_1_0 = nn.Conv2d(
            channels_in, n, kernel_size=3, stride=2, padding="VALID"
        )
        self.conv_2_0 = nn.Conv2d(channels_in, k, kernel_size=1)
        self.conv_2_1 = nn.Conv2d(k, l, kernel_size=3)
        self.conv_2_2 = nn.Conv2d(l, m, kernel_size=3, stride=2, padding="VALID")
...
class InceptionB(nn.Module):
    def __init__(self, channels_in):
        ...
        self.conv_2_1 = nn.Conv2d(192, 224, kernel_size=(1, 7))
        self.conv_2_2 = nn.Conv2d(224, 256, kernel_size=(7, 1))

        self.conv_3_0 = nn.Conv2d(channels_in, 192, kernel_size=1)
        self.conv_3_1 = nn.Conv2d(192, 192, kernel_size=(1, 7))
        self.conv_3_2 = nn.Conv2d(192, 224, kernel_size=(7, 1))
        self.conv_3_3 = nn.Conv2d(224, 224, kernel_size=(1, 7))
        self.conv_3_4 = nn.Conv2d(224, 256, kernel_size=(7, 1))
...
class ReductionB(nn.Module):
    def __init__(self, channels_in):
        ...
        self.conv_1_1 = nn.Conv2d(192, 192, kernel_size=3, stride=2, padding="VALID")

        self.conv_2_0 = nn.Conv2d(channels_in, 256, kernel_size=1)
        self.conv_2_1 = nn.Conv2d(256, 256, kernel_size=(1, 7))
        self.conv_2_2 = nn.Conv2d(256, 320, kernel_size=(1, 7))
        self.conv_2_3 = nn.Conv2d(320, 320, kernel_size=3, stride=2, padding="VALID")
...
class InceptionC(nn.Module):
    def __init__(self, channels_in):
        ...
        self.conv_2_1_0 = nn.Conv2d(384, 256, kernel_size=(1, 3))
        self.conv_2_1_1 = nn.Conv2d(384, 256, kernel_size=(3, 1))

        self.conv_3_0 = nn.Conv2d(channels_in, 384, kernel_size=1)
        self.conv_3_1 = nn.Conv2d(384, 448, kernel_size=(1, 3))
        self.conv_3_2 = nn.Conv2d(448, 512, kernel_size=(3, 1))
        self.conv_3_3_0 = nn.Conv2d(512, 256, kernel_size=(3, 1))
        self.conv_3_3_1 = nn.Conv2d(512, 256, kernel_size=(1, 3))
