...
class dense_base_unit(base_block):
    ...
    def __init__(
        self, channels_in, channels_out, drop_rate,
    ):
        super().__init__(
...
class dense_orig_bottleneck_unit(dense_base_unit):
    ...
    def __init__(
        ...
        super().__init__(
            channels_in, channels_out * self.expansion, drop_rate,
        )
...
class dense_block(nn.ModuleDict):
    def __init__(
        self, block_type, nlayers, channels_in, growth_rate, drop_rate,
    ):
        super().__init__()
        layer = block_type(channels_in=channels_in, channels_out=growth_rate, drop_rate=drop_rate)
